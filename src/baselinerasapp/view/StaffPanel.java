...
//si quisieramos exigir restricciones deberiamos usar un TableModel, molaria mas otro frame y cambiar editable a null
    ...
    private void BuildTable() {//se podria meter en un scrollpane
        staffTable = new JTable(data, columnNames);//igual lo cambio con tableModel, lo estoy pensando, no se si eso es mas de conrolador, en cualquier caso hay que cambiar el constructor
    ...
    private void BuildHeader() {
        ...
        this.add(new JLabel("Empleados"), BorderLayout.PAGE_START);
    }
}
